...
\section*{Problem 4}
Pseudocodes are written in matrixmult.py files as code comments.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{HW6/Runtime&N.png}
    \caption{The plot of the relationship between runtime and the input size N}
    \label{fig:my_image}
\end{figure}
